...
#     amarillo_cl = np.array([131, 231, 251])
    
   
#     rojo_osc = np.array([0,0,138])
#     rojo_cl = np.array([77,77,234])
     
#     verde_osc = np.array([0,108,89])
#     verde_cl = np.array([79,255,223])

#     azul_osc = np.array([155,31,35])
#     azul_cl = np.array([247,244,147])
    
#     negro_oscuro = np.array([0, 0, 0])
#     negro_claro = np.array([85, 94, 91]) 
